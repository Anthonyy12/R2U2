...
import AddActVintich from './AddActVintich';
    ...
    <Container>
      <Row className="px-4 my-5">
        <Col className="px-2 my-2">
          <h1>Proyecto: Vintich</h1>
          <br/>
					<h5>Responsable: Juan Carlos Bodoque</h5>
					<br/>
					<h6>Fecha de Inicio: 2024-09-10</h6>
					<h6>Fecha de Finalización: 2024-03-09</h6>
        </Col>
        <Row className="px-4 my-5">
          <Col>
            <h3>Actividades</h3>
          ...
          <Col key={actividad.id} className="px-2 my-2">
            <Card style={{ width: '20rem' }}>
              ...
              <Card.Body>
                ...
                <Link to={{ pathname: '/subact-vintich' }}>
      ...
      <Modal show={showModal} onHide={handleCloseModal}>
        ...
        <Modal.Body>
          ...
          <AddActVintich onCrearActividad={handleCrearActividad} />
        </Modal.Body>
      </Modal>
    </Container>
  )
