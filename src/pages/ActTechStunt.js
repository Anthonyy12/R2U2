...
import AddActTechStunt from './AddActTechStunt';
    ...
    <Container>
          ...
          <Col key={actividad.id} className="px-2 my-2">
            <Card style={{ width: '20rem' }}>
              ...
              <Card.Body>
                ...
                <Link to={{ pathname: '/subact-techstunt' }}>
      ...
      <Modal show={showModal} onHide={handleCloseModal}>
        ...
        <Modal.Body>
          ...
          <AddActTechStunt onCrearActividad={handleCrearActividad} />
        </Modal.Body>
      </Modal>
    </Container>
  );
